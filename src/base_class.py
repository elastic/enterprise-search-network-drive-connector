...
class BaseClass(object):
    ...
    def __init__(self, **kwargs):
        ...
        self.enable_document_permission = self.configurations.get("enable_document_permission")
        self.user_mapping = self.configurations.get("networkdrive_enterprisesearch.user_mapping")
